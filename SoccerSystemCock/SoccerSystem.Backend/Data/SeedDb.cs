...
public class SeedDb
{
    ...
    private async Task CheckUsersAsync1()
    {
        await CheckUserAsync("Janier", "Machado", "jomr@yopmail.com", "322 311 4620", "JuanZuluaga.jpg", UserType.Admin);
    ...
    private async Task<User> CheckUserAsync(string firstName, string lastName, string email, string phone, string image, UserType userType)
    {
        ...
        if (user == null)
        {
            ...
            var imagePath = $"\\Images\\users\\{image}.jpg";
