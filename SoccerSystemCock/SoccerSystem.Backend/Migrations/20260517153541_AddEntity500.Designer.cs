...
namespace SoccerSystem.Backend.Migrations
{
    ...
    [Migration("20260517153541_AddEntity500")]
    partial class AddEntity500
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoccerSystem.Shared.Entites.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SoccerSystem.Shared.Entites.Prediction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SoccerSystem.Shared.Entites.TournamentTeam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SoccerSystem.Shared.Entites.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SoccerSystem.Shared.Entites.UserGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SoccerSystem.Shared.Entites.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SoccerSystem.Shared.Entites.Group", b =>
                {
                    b.HasOne("SoccerSystem.Shared.Entites.User", "Admin")
            ...
            modelBuilder.Entity("SoccerSystem.Shared.Entites.Prediction", b =>
                {
                    b.HasOne("SoccerSystem.Shared.Entites.Group", "Group")
                        .WithMany()
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SoccerSystem.Shared.Entites.Match", "Match")
                        .WithMany()
                    ...
                    b.HasOne("SoccerSystem.Shared.Entites.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SoccerSystem.Shared.Entites.TournamentTeam", b =>
                {
                    b.HasOne("SoccerSystem.Shared.Entites.Team", "Team")
